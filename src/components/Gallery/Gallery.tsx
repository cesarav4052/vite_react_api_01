...
/* Datos de productos = Demo json lista de productos, solo se utiliza para programar el formato de 
    objetos json que traera el API
...
const Gallery = () => {
    ...
    /* Demo json lista de productos, solo se utiliza para programar el formato de 
    objetos json que traera el API
